    ...
    <form method="post" enctype="multipart/form-data">
        <?php
            if(isset($_POST['acao'])){
                ...
                if($login == ''){
                    Painel::alert('erro','   Campo login é obrigatório!');
                }else if($nome == ''){
                    Painel::alert('erro','   Campo nome é obrigatório!');
                }else if($senha == ''){
                    Painel::alert('erro','   Campo senha é obrigatório!');
                }else if($cargo == ''){
                    Painel::alert('erro','   Necessário selecionar cargo!');
                }else if($imagem['name'] == ''){
                    Painel::alert('erro','   Selecione uma foto!');
                }else{
                    //Podemos cadastrar!
