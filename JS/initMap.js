$(function () {
    ...
    function initialize() {
        ...
        var mapProp = {
            center: new google.maps.LatLng(-25.43218129245027, -49.260719012924085),//onde deseja que o map comece
            zoom: 14,
            scrollwheel: false,
            styles: [{
                stylers: [{
    ...
    initialize();
    addMarker(-25.43218129245027, -49.260719012924085, '', "Minha casa", false, true);
})
